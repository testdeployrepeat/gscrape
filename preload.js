...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    launchBulkBrowser: (options) => ipcRenderer.invoke('launch-bulk-browser', options),
    scrapeInTab: (options) => ipcRenderer.invoke('scrape-in-tab', options),
    closeBulkBrowser: () => ipcRenderer.invoke('close-bulk-browser'),
